...
typedef struct {
    ...
    double HIV_background_testing_rate_multiplier_pre2006; /* Baseline probability of a women having an HIV test in the background cascade from start of HIV testing until 2006. */
    double HIV_background_testing_rate_multiplier; /* Baseline annual probability of a women having an annual test in the background cascade. */
...
typedef struct{ /* structure which contains all the strings that are outputted */
    ...
    long PC_NPOP[NPATCHES][N_GENDER][PC_AGE_RANGE_MAX][NPC_ROUNDS - 1];
    long PC_NPOSITIVE[NPATCHES][N_GENDER][PC_AGE_RANGE_MAX][NPC_ROUNDS - 1];
    long PC_NAWARE[NPATCHES][N_GENDER][PC_AGE_RANGE_MAX][NPC_ROUNDS - 1];
    long PC_NONART[NPATCHES][N_GENDER][PC_AGE_RANGE_MAX][NPC_ROUNDS - 1];
    long PC_NVS[NPATCHES][N_GENDER][PC_AGE_RANGE_MAX][NPC_ROUNDS - 1];
} output_struct;
