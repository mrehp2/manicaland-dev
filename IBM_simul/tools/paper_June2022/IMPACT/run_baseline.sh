...
#python /home/mike/MANICALAND/manicaland-dev/IBM_simul/python/generate_art_distribution_files.py $outputdirectory/Output


# Post-process the calibration files to include sample and rep numbers in the csv files
python calibration_add_sample_rep_numbers.py $outputdirectory/Output $nsamples $nreps
