...
USE_STDEV = 0 # Print mean +/- 1.96*s.d. or not in make_mean_CI()
...
def read_MIHPSA_header(mihpsa_filename):
    ...
    i_N_newHIVinfections_15to49_male = header.index('N_newHIVinfections_15to49_male')
    i_N_newHIVinfections_15to49_female = header.index('N_newHIVinfections_15to49_female')
...
def make_mean_CI(outputs_dict,output_names):
    ...
    for outputname in output_names:
        ...
        for y in range(1990,2041):
            ...
            ll_output += [numpy.percentile(outputs_dict[outputname][y],2.5)]
            ul_output += [numpy.percentile(outputs_dict[outputname][y],97.5)]
            ll_stdev += [numpy.mean(outputs_dict[outputname][y]) - 1.96* numpy.std(outputs_dict[outputname][y])]
            ul_stdev += [numpy.mean(outputs_dict[outputname][y]) + 1.96* numpy.std(outputs_dict[outputname][y])]

        #output_string += outputname + "\n"
        #output_string += " ".join([str(x) for x in mean_output]) +  "\n"
        #output_string += " ".join([str(x) for x in ll_output]) +  "\n"
        #output_string += " ".join([str(x) for x in ul_output]) +  "\n"
        output_string += outputname + " "
...
def read_mihpsa_files_and_make_summary_file(mihpsafiledir):
    ...
    for n,f in enumerate(mihpsafiles):
        ...
        for i,line in enumerate(run_data):
            ...
            [year,NpopM15_49,NpopF15_49,PosM15_49,PosF15_49,artM15plus,artF15plus,art_child,NpopM15plus,NpopF15plus,Npop_child,circ,NposM15plus,NposF15plus,Npos_child,NawareM15plus,NawareF15plus,NonARTM15plus,NonARTF15plus,N_VSM15plus,N_VSF15plus,N_women_sexuallyactive_15to24,N_women_usecondomlastact_15to24,N_deaths_20_59_male,N_deaths_20_59_female,N_AIDSdeaths_15plus_male,N_AIDSdeaths_15plus_female,N_AIDSdeaths_children_under15,N_HIVtests_15plus_male,N_HIVtests_15plus_female,N_newHIVinfections_15to49_male,N_newHIVinfections_15to49_female,N_newHIVdiagnoses_15plus] = [int(line.split(",")[index]) for index in [0,i_NpopM15_49,i_NpopF15_49,i_PosM15_49,i_PosF15_49,i_artM15plus,i_artF15plus,i_art_child,i_NpopM15plus,i_NpopF15plus,i_Npop_child,i_circ,i_NposM15plus,i_NposF15plus,i_Npos_child,i_NawareM15plus,i_NawareF15plus,i_NonARTM15plus,i_NonARTF15plus,i_N_VSM15plus,i_N_VSF15plus,i_N_women_sexuallyactive_15to24,i_N_women_usecondomlastact_15to24,i_N_deaths_20_59_male,i_N_deaths_20_59_female,i_N_AIDSdeaths_15plus_male,i_N_AIDSdeaths_15plus_female,i_N_AIDSdeaths_children_under15,i_N_HIVtests_15plus_male,i_N_HIVtests_15plus_female,i_N_newHIVinfections_15to49_male,i_N_newHIVinfections_15to49_female,i_N_newHIVdiagnoses_15plus]]
            if(n==0):
    ...
    # UNAIDS definition of ART coverage: Percentage of people living with HIV currently receiving ART among the estimated number of adults and children living with HIV
                ...
                outputs_Ncumulativecases_M15_49[year] = [N_newHIVinfections_15to49_male*scale_tot_adult]
                outputs_Ncumulativecases_F15_49[year] = [N_newHIVinfections_15to49_female*scale_tot_adult]
                ...
                outputs_circ_cumulative15_49[year] += [circ*scale_VMMC] 
    ...
    outputs_to_store = {"PrevalenceM15_49":outputs_prevalence_M15_49,
    ...
    list_of_outputs = ["PrevalenceM15_49","PrevalenceF15_49","PrevalenceAll15_49","N_ART_M_15plus","N_ART_F_15plus","N_ART_child","N_ART_total","ARTcoverage_M_15plus","ARTcoverage_F_15plus","ARTcoverage_child","ARTcoverage_total","Circumcision","PropDiagnosed_M15plus","PropDiagnosed_F15plus","PropF15_24_condlasttime","PropAdultVS","New_cases_M15_49","New_cases_F15_49","New_cases_total15_49","IncidenceM15_49","IncidenceF15_49","Incidencetotal15_49","AIDSdeaths_M15plus","AIDSdeaths_F15plus","AIDSdeaths_child","AIDSdeaths_total","totaldeaths_M20_59","totaldeaths_F20_59","totaldeaths_adult20_59","Ntests_M15plus","Ntests_F15plus","Ntests_adult15plus","Prop_tests_pos_15plus"]
