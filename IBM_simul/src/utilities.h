...
void calcul_n_new_partners_f_to_m(patch_struct *, parameters *, int, int, int);
void calcul_n_new_partners_m_to_f(patch_struct *, parameters *, int, int, int);
...
void calculate_current_c_within_patch(parameters *, double [2], double [2], int);
void calculate_c_between_patches(parameters *, int);
