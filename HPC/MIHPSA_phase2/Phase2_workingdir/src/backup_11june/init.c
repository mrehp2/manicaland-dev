...
void set_up_population(int p, patch_struct *patch, population *pop, int scenario_flag){
    ...
    person_template.reason_next_HIV_test = NOEVENT;        /* Initialize at dummy value. */
...
void init_cumulative_counters(cumulative_outputs_struct *cumulative_outputs){
    ...
    for(g=0; g<N_GENDER; g++){
    	cumulative_outputs->cumulative_outputs_MIHPSA->N_deaths_15plus[g] = 0;
	...
	cumulative_outputs->cumulative_outputs_MIHPSA->N_HIVtests_symptomatic_15plus[g] = 0;
	cumulative_outputs->cumulative_outputs_MIHPSA->N_newHIVinfections_15plus[g] = 0;
	...
	cumulative_outputs->cumulative_outputs_MIHPSA->N_newHIVdiagnoses_15plus[g] = 0;
	cumulative_outputs->cumulative_outputs_MIHPSA->YLL_15plus[g] = 0;
	cumulative_outputs->cumulative_outputs_MIHPSA->YLL_15plus_discounted[g] = 0;
    }
    cumulative_outputs->cumulative_outputs_MIHPSA->N_newbirths = 0;
    cumulative_outputs->cumulative_outputs_MIHPSA->N_newbirths_HIVpos = 0;
    cumulative_outputs->cumulative_outputs_MIHPSA->N_AIDSdeaths_children_under15 = 0;
    cumulative_outputs->cumulative_outputs_MIHPSA->YLL_children_under15 = 0;
    cumulative_outputs->cumulative_outputs_MIHPSA->YLL_children_under15_discounted = 0;

    cumulative_outputs->cumulative_outputs_MIHPSA->N_ARTinitiations_15plus = 0;
