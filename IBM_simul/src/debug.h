...
void check_if_individual_should_be_in_list_susceptibles_in_serodiscordant_partnership(individual *,
    all_partnerships * );
void check_if_individual_should_be_in_list_susceptibles_in_hsv2serodiscordant_partnership(individual *, all_partnerships * );
...
void create_header_for_cascade_count_files(char *, int , int );
