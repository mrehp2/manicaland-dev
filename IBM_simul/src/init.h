...
void set_population_count_one_year_zero(population_size_one_year_age *);
void set_population_all_strata_count_one_year_zero(population_size_one_year_age_hiv_by_stage_treatment *);
