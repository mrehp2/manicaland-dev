...
void draw_initial_hiv_tests(parameters *, age_list_struct *, double, individual ***, 
    long *, long *);
void draw_hiv_tests(parameters *, age_list_struct *, int , individual ***, long *, long *, int , patch_struct *, int );
...
void schedule_new_PrEPrelated_hiv_test(individual *, parameters *, double , individual ***, long *, long *, int );
