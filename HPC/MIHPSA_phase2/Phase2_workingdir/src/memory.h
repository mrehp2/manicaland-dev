...
void free_all_patch_memory(parameters *, individual *, population_size *, 
	...
	long ****, long ****, PC_sample_struct *, PC_cohort_struct *, PC_cohort_data_struct *, PrEP_background_sample_struct *, PrEP_intervention_sample_struct *, MIHPSA_intervention_sample_struct *);
